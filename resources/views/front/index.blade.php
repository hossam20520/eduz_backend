...
-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/assets/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/assets/css/font-awesome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/assets/css/templatemo-art-factory.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/assets/css/owl-carousel.css')}}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">EDUZ</a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="#welcome" class="active">{{ trans('lang.Home') }} </a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <h1>Choose The Best <strong>for YOU</strong></h1>
                        <p>For your childern's education easily from a lot of multiple options, offers and discounts provided by EDUZ App</p>
                        <a href="#about" class="main-button-slider">Find Out More</a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                        <img src="{{ asset('css/assets/images/slider-icon.png')}}" class="rounded img-fluid d-block mx-auto" alt="First Vector Graphic">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="{{ asset('css/assets/images/left-image.png')}}" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
                <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                    ...
                    <div class="left-text">
                        <p>All educationsl institutions and training centers through the data and results of evaluations provided by EDUZ APP    <br><br>
                       </p>
        ...
        <div class="container">
            <div class="row">
                <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
                    ...
                    <p>For all educational institutions and training centers through EDUZ App to obtain comprehensive , accurate and documented data</p>
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="text">
                                ...
                                <p> downloadable ZIP file on any website.</p>
                            </div>
                        </li>
                        <li>
    ...
    <!-- jQuery -->
    <script src="{{ asset('css/assets/js/jquery-2.1.0.min.js')}}"></script>

    <!-- Bootstrap -->
    <script src="{{ asset('css/assets/js/popper.js')}}"></script>
    <script src="{{ asset('css/assets/js/bootstrap.min.js')}}"></script>

    <!-- Plugins -->
    <script src="{{ asset('css/assets/js/owl-carousel.js')}}"></script>
    <script src="{{ asset('css/assets/js/scrollreveal.min.js')}}"></script>
    <script src="{{ asset('css/assets/js/waypoints.min.js')}}"></script>
    <script src="{{ asset('css/assets/js/jquery.counterup.min.js')}}"></script>
    <script src="{{ asset('css/assets/js/imgfix.min.js')}}"></script> 
