        ...
        <ul class="navigation-left">
          ...
          >
            <router-link tag="a" class="nav-item-hold" to="/app/dashboard">
              <img src="https://cdn-icons-png.flaticon.com/512/3408/3408591.png" width="50%"/>
          ...
          <li
            ...
            <a class="nav-item-hold" href="#">
              ...
              <img src="https://cdn-icons-png.flaticon.com/512/4401/4401713.png" width="50%"/> 
          ...
          <li 
            ...
            :data-submenu="true">
            <a class="nav-item-hold" href="#">
              <img src="https://cdn-icons-png.flaticon.com/512/1048/1048950.png" width="50%"/> 
          ...
          <li  @mouseenter="toggleSubMenu"
            ...
            :data-submenu="true">
            <a class="nav-item-hold" href="#">
              <img src="https://cdn-icons-png.flaticon.com/512/4306/4306892.png" width="50%"/> 
...
<!-- 
          <li
              @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'Kindergrants' }"
            data-item="Kindergrants"
            :data-submenu="true">
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Library-2"></i>
              <span class="nav-text">{{   $t('Kindergrants')  }}</span>
            </a>
            <div class="triangle"></div>
          </li> -->
...
<!--           
          ...
          >
            <a class="nav-item-hold" href="#">
              ...
              <img src="https://cdn-icons-png.flaticon.com/512/921/921347.png" width="50%"/> 
          ...
          >
            <a class="nav-item-hold" href="#">
              <img src="https://cdn-icons-png.flaticon.com/512/738/738853.png" width="50%"/>
          ...
          >
            <a class="nav-item-hold" href="#">
            <img src="https://cdn-icons-png.flaticon.com/512/3029/3029337.png" width="50%"/>
      ...
      <div ref="sidebarChild">
        ...
        <ul
          ...
          <li
            class="nav-item"
            >
            <router-link tag="a" class to="/app/forms/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{  $t('formsList') }}</span>
            </router-link>
          </li>
        ...
        <ul
          ...
          :class="{ 'd-block': selectedParentMenu == 'teachers' }">

          <li
            class="nav-item"
        >
            <router-link tag="a" class to="/app/teachers/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{  $t('AddTeacher')  }}</span>
            </router-link>
          </li>
          ...
          <li
            class="nav-item"
            >
            <router-link tag="a" class to="/app/teachers/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{  $t('teachersList') }}</span>
            </router-link>
          </li>
        ...
        <ul
          ...
          :class="{ 'd-block': selectedParentMenu == 'educations' }">

          <li
            class="nav-item"  >
            <router-link tag="a" class to="/app/educations/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{  $t('AddEducation')  }}</span>
            </router-link>
          </li>
        ...
        <ul
          class="childNav d-none"
          data-parent="Kindergrants"
          :class="{ 'd-block': selectedParentMenu == 'Kindergrants' }">

          <li
            class="nav-item"
           >
            <router-link tag="a" class to="/app/Kindergrants/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{  $t('AddKindergrant')  }}</span>
            </router-link>
          </li>
          ...
          <li
            class="nav-item"
            >
            <router-link tag="a" class to="/app/Kindergrants/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{  $t('KindergrantsList') }}</span>
            </router-link>
          </li>
        ...
        >
          ...
          <li
            class="nav-item">
            <router-link tag="a" class to="/app/settings/Institutions">
              <i class="nav-icon i-Bookmark"></i>
          ...
          <!-- <li
            class="nav-item" >
            <router-link tag="a" class to="/app/settings/Cats">
              <i class="nav-icon i-Bookmark"></i>
              <span class="item-name">{{   $t('Cat') }}</span>
            </router-link>
          </li> -->
          <li
            class="nav-item"
