        ...
        children: [
            {
               ...
               {
                path: "/app/forms",
                component: () => import(/* webpackChunkName: "forms" */ "./views/app/pages/forms"),
                ...
                children: [
                    {
                        ...
                        path: "list",
                        component: () =>
                            import(/* webpackChunkName: "index_forms" */"./views/app/pages/forms/index_forms")
                    },
       ...
       
                    {
                        ...
                        name: "detail_form",
                        component: () =>
                            import(/* webpackChunkName: "detail_form" */"./views/app/pages/forms/Detail_Form")
                    }
               ...
               {
                path: "/app/teachers",
                component: () => import(/* webpackChunkName: "teachers" */ "./views/app/pages/teachers"),
                ...
                children: [
                    {
                        ...
                        path: "list",
                        component: () =>
                            import(/* webpackChunkName: "index_teachers" */"./views/app/pages/teachers/index_teachers")
                    },
                    {
                        path: "store",
                        name: "store_teacher",
                        component: () =>
                            import(/* webpackChunkName: "store_teacher" */"./views/app/pages/teachers/Add_teacher")
                    },
                    {
                        path: "edit/:id",
                        name: "edit_teacher",
                        component: () =>
                            import(/* webpackChunkName: "edit_teacher" */"./views/app/pages/teachers/Edit_teacher")
                    },
                    {
                        path: "detail/:id",
                        name: "detail_teacher",
                        component: () =>
                            import(/* webpackChunkName: "detail_teacher" */"./views/app/pages/teachers/Detail_Teacher")
                    }
...

            {
                ...
                component: () => import(/* webpackChunkName: "Kindergrants" */ "./views/app/pages/Kindergrants"),
                ...
                children: [
                    {
                        ...
                        path: "list",
                        component: () =>
                            import(/* webpackChunkName: "index_Kindergrants" */"./views/app/pages/Kindergrants/index_Kindergrants")
                    },
                    {
                        path: "store",
                        name: "store_kindergrant",
                        component: () =>
                            import(/* webpackChunkName: "store_kindergrant" */"./views/app/pages/Kindergrants/Add_kindergrant")
                    },
                    {
                        path: "edit/:id",
                        name: "edit_kindergrant",
                        component: () =>
                            import(/* webpackChunkName: "edit_kindergrant" */"./views/app/pages/Kindergrants/Edit_kindergrant")
                    },
                    {
                        path: "detail/:id",
                        name: "detail_kindergrant",
                        component: () =>
                            import(/* webpackChunkName: "detail_kindergrant" */"./views/app/pages/Kindergrants/Detail_Kindergrant")
                    }
                    ...
                    {
                        path: "/app/educations",
                        component: () => import(/* webpackChunkName: "educations" */ "./views/app/pages/educations"),
                        ...
                        children: [
                            {
                                ...
                                path: "list",
                                component: () =>
                                    import(/* webpackChunkName: "index_educations" */"./views/app/pages/educations/index_educations")
                            },
                            {
                                path: "store",
                                name: "store_education",
                                component: () =>
                                    import(/* webpackChunkName: "store_education" */"./views/app/pages/educations/Add_education")
                            },
                            {
                                path: "edit/:id",
                                name: "edit_education",
                                component: () =>
                                    import(/* webpackChunkName: "edit_education" */"./views/app/pages/educations/Edit_education")
                            },
                            {
                                path: "detail/:id",
                                name: "detail_education",
                                component: () =>
                                    import(/* webpackChunkName: "detail_education" */"./views/app/pages/educations/Detail_Education")
                            }
            ...
            // Settings
            {
                ...
                children: [
                                            ...
                                            // areas
                    {
                        ...
                        path: "Areas",
                        component: () =>
                            import(/* webpackChunkName: "Areas" */"./views/app/pages/settings/areas")
                    },
                    ...
                    // brands
                    {
                        ...
                        component: () =>
                          ...
                          // institutions
                          {
                            ...
                            path: "Institutions",
                            component: () =>
                                import(/* webpackChunkName: "Institutions" */"./views/app/pages/settings/institutions")
                        },
                    ...
                    // cats
                    {
                        ...
                        path: "Cats",
                        component: () =>
                            import(/* webpackChunkName: "Cats" */"./views/app/pages/settings/cats")
                    },
                    // Backup
                    {
                        name: "Backup",
