...
export default {
    ...
    Name_ar_name:'Arabic Name',
    Name_en_name:'English Name',
    en_country:'English Country Name',
    ar_country:'Arabic Country Name',
    ar_subject:'Arabic Subject Name',
    en_subject:'English Subject Name',
    age_from:'Age From',
    age_to:'Age To',
    share:'Share Link',
    Choose_instation:'Choose Instation',
