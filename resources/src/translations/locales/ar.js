...
export default {
    ...
    Name_en_name:'الاسم بالانجليزي',
    en_country:'اسم المدينة بالانجليزي',
    ar_country:'اسم المدينة بالعربي',
    ar_subject:'اسم المادة بالعربي',
    en_subject:'اسم المادة بالانجليزي',
    age_from:'السن من ',
    age_to:'السن الى',
    share:'رابط المشاركة',
    Choose_instation:'اختر المؤسسة',
    ar_about:'المعلومات بالعربي',
    en_about:'المعلومات بالانجلش',
