<template>
  <div class="main-content">
    <breadcumb :page="$t('blogsList')" :folder="$t('Blogs')"/>
    ...
    <div v-else>
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            <router-link
              ...
              v-b-tooltip.hover
              title="View"
              :to="{ name:'detail_blog', params: { id: props.row.id} }"
            >
            ...
            <router-link
              ...
              v-b-tooltip.hover
              title="Edit"
              :to="{ name:'edit_blog', params: { id: props.row.id } }">
              <i class="i-Edit text-25 text-success"></i>
            </router-link>

            <a
           
              @click="Remove_Blog(props.row.id)"
              v-b-tooltip.hover
              title="Delete" >
      ...
      <b-sidebar id="sidebar-right" :title="$t('Filter')" bg-variant="white" right shadow>
        <div class="px-3 py-2">
          <b-row>
            ...
            <b-col md="6" sm="12">
              <b-button
                @click="Get_Blogs(serverParams.page)"
                variant="primary m-1"
                size="sm"
                block
              >
      ...
      <!-- Modal Show Import Blogs -->
      <b-modal
        ok-only
        ok-title="Cancel"
        size="md"
        id="importBlogs"
        :title="$t('import_blogs')">
...
export default {
  ...
  methods: {
    ...
    Submit_import() {
      ...
      axios
        .post("Blogs/import/csv", self.data)
        .then(response => {
    ...
    delete_by_selected() {
      this.$swal({
        ...
        if (result.value) {
          ...
          NProgress.set(0.1);
          axios
            .post("Blogs/delete/by_selection", {
