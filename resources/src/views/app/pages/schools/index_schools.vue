<template>
  <div class="main-content">
    <breadcumb :page="$t('schoolsList')" :folder="$t('Schools')"/>
    ...
    <div v-else>
      ...
      >
        ...
        <div slot="table-actions" class="mt-2 mb-3">
          ...
          <b-button @click="School_Excel()" size="sm" variant="outline-danger m-1">
            <i class="i-File-Excel"></i> EXCEL
          </b-button>
 
          <router-link
            class="btn-sm btn btn-primary btn-icon m-1"
            v-if="currentUserPermissions && currentUserPermissions.includes('schools_add')"
            to="/app/schools/store">
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            <router-link
              ...
              v-b-tooltip.hover
              title="View"
              :to="{ name:'detail_school', params: { id: props.row.id} }"
            >
            ...
            <router-link
              ...
              v-b-tooltip.hover
              title="Edit"
              :to="{ name:'edit_school', params: { id: props.row.id } }">
              <i class="i-Edit text-25 text-success"></i>
            </router-link>

            <a
             
              @click="Remove_School(props.row.id)"
              v-b-tooltip.hover
              title="Delete" >
      ...
      <b-sidebar id="sidebar-right" :title="$t('Filter')" bg-variant="white" right shadow>
        <div class="px-3 py-2">
          <b-row>
            ...
            <b-col md="6" sm="12">
              <b-button
                @click="Get_Schools(serverParams.page)"
                variant="primary m-1"
                size="sm"
                block
              >
      ...
      <!-- Modal Show Import Schools -->
      <b-modal
        ok-only
        ok-title="Cancel"
        size="md"
        id="importSchools"
        :title="$t('import_schools')">
...
export default {
  ...
  methods: {
    ...
    Submit_import() {
      ...
      axios
        .post("Schools/import/csv", self.data)
        .then(response => {
    ...
    delete_by_selected() {
      this.$swal({
        ...
        if (result.value) {
          ...
          NProgress.set(0.1);
          axios
            .post("Schools/delete/by_selection", {
  ...
  created: function() {
    ...
    Fire.$on("Event_import", () => {
      setTimeout(() => {
        this.Get_Schools(this.serverParams.page);
        this.$bvModal.hide("importSchools");
      }, 500);
    });
  }
};
