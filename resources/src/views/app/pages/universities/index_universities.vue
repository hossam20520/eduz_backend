    ...
    <div v-else>
      ...
      >
        ...
        <div slot="table-actions" class="mt-2 mb-3">
          ...
          <b-button @click="Universitie_Excel()" size="sm" variant="outline-danger m-1">
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            <router-link
              ...
              v-b-tooltip.hover
              title="View"
              :to="{ name:'detail_universitie', params: { id: props.row.id} }"
            >
            ...
            <router-link
              ...
              v-b-tooltip.hover
              title="Edit"
              :to="{ name:'edit_universitie', params: { id: props.row.id } }">
              <i class="i-Edit text-25 text-success"></i>
            </router-link>

            <a
             
              @click="Remove_Universitie(props.row.id)"
              v-b-tooltip.hover
              title="Delete" >
      ...
      <b-sidebar id="sidebar-right" :title="$t('Filter')" bg-variant="white" right shadow>
        <div class="px-3 py-2">
          <b-row>
            ...
            <b-col md="6" sm="12">
              <b-button
                @click="Get_Universities(serverParams.page)"
                variant="primary m-1"
                size="sm"
                block
              >
      ...
      <!-- Modal Show Import Universities -->
      <b-modal
        ok-only
        ok-title="Cancel"
        size="md"
        id="importUniversities"
        :title="$t('import_universities')">
...
export default {
  ...
  methods: {
    ...
    Submit_import() {
      ...
      axios
        .post("Universities/import/csv", self.data)
        .then(response => {
          ...
          axios
            ...
            .then(() => {
              this.$swal(
                ...
                this.$t("Delete.UniversitieDeleted"),
                "success"
              );
    ...
    delete_by_selected() {
      this.$swal({
        ...
        if (result.value) {
          ...
          NProgress.set(0.1);
          axios
            .post("Universities/delete/by_selection", {
  ...
  created: function() {
    ...
    Fire.$on("Event_import", () => {
      setTimeout(() => {
        this.Get_Universities(this.serverParams.page);
        this.$bvModal.hide("importUniversities");
      }, 500);
    });
  }
};
