...
<template>
  <div class="main-content">
    <breadcumb :page="$t('AddEntertainment')" :folder="$t('Entertainment')" />
    <div v-if="isLoading" class="loading_page spinner spinner-primary mr-3"></div>

    <validation-observer ref="Create_Center" v-if="!isLoading">
      <b-form @submit.prevent="Submit_Center" enctype="multipart/form-data">
        <b-row>
          <b-col md="8">
            <b-card>
              <b-row>
                  ...
                  <validation-provider name="lat" :rules="{ required: true, min: 3, max: 55 }" v-slot="validationContext">
                    <b-form-group :label="$t('lat')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="lat" :placeholder="$t('lat')" v-model="center.lat"></b-form-input>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="long" :rules="{ required: true, min: 3, max: 55 }" v-slot="validationContext">
                    <b-form-group :label="$t('long')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="long" :placeholder="$t('long')" v-model="center.long"></b-form-input>
                      <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="ar_name" :rules="{ required: true, min: 3, max: 55 }"
                    ...
                    <b-form-group :label="$t('ar_name')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="ar_name" :placeholder="$t('ar_name')" v-model="center.ar_name"></b-form-input>
                      <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="en_name" :rules="{ required: true, min: 3, max: 55 }"
                    ...
                    <b-form-group :label="$t('en_name')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="en_name" :placeholder="$t('en_name')" v-model="center.en_name"></b-form-input>
                      <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="url" :rules="{ required: true, min: 3, max: 55 }" v-slot="validationContext">
                    <b-form-group :label="$t('url')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="url" :placeholder="$t('url')" v-model="center.url"></b-form-input>
                      <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="phone" :rules="{ required: true, min: 3, max: 55 }" v-slot="validationContext">
                    <b-form-group :label="$t('phone')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="url" :placeholder="$t('phone')" v-model="center.phone"></b-form-input>
                      <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="share" :rules="{ required: true, min: 3, max: 600 }" v-slot="validationContext">
                    <b-form-group :label="$t('share')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="share" :placeholder="$t('share')" v-model="center.share"></b-form-input>
                      <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                  ...
                  <validation-provider name="category" :rules="{ required: true }">
                    <b-form-group slot-scope="{ valid, errors }" :label="$t('Choose_instation')">
                      <v-select :class="{ 'is-invalid': !!errors.length }"
                        ...
                        :placeholder="$t('Choose_instation')" v-model="center.institution_id"
                        :options="centers.map(centers => ({ label: centers.ar_name, value: centers.id }))" />
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="Govs" :rules="{ required: true }">
                    <b-form-group slot-scope="{ valid, errors }" :label="$t('Choose_Gov')">
                      <v-select :class="{ 'is-invalid': !!errors.length }"
                        :state="errors[0] ? false : (valid ? true : null)" :reduce="label => label.value"
                        :placeholder="$t('choosGov')" v-model="center.gov_id"
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="Areas" :rules="{ required: true }">
                    <b-form-group slot-scope="{ valid, errors }" :label="$t('Choose_Area')">
                      <v-select :class="{ 'is-invalid': !!errors.length }"
                        :state="errors[0] ? false : (valid ? true : null)" :reduce="label => label.value"
                        :placeholder="$t('Choose_Area')" v-model="center.area_id"
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('en_info')">
                    <vue-editor v-model="center.en_info" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('ar_info')">
                    <vue-editor v-model="center.ar_info" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('facilities_ar')">
                    <vue-editor v-model="center.facilities_ar" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('facilities_en')">
                    <vue-editor v-model="center.facilities_en" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('activities_ar')">
                    <vue-editor v-model="center.activities_ar" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('activities_en')">
                    <vue-editor v-model="center.activities_en" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('paid_en_info')">
                    <vue-editor v-model="center.paid_en_info" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('paid_ar_info')">
                    <vue-editor v-model="center.paid_ar_info" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('paid_facilities_ar')">
                    <vue-editor v-model="center.paid_facilities_ar" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="12" class="mb-2">
                  <b-form-group :label="$t('paid_facilities_en')">
                    <vue-editor v-model="center.paid_facilities_en" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="subscription" :rules="{ required: true }">
                    <b-form-group slot-scope="{ valid, errors }" :label="$t('subscription')">
                      <v-select :class="{ 'is-invalid': !!errors.length }"
                        :state="errors[0] ? false : (valid ? true : null)" v-model="center.free"
                  ...
                  <validation-provider name="Product Cost" :rules="{ required: true, regex: /^\d*\.?\d*$/ }"
                    ...
                    <b-form-group :label="$t('from')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="ProductCost-feedback"
                        label="Cost" :placeholder="$t('from')" v-model="center.exp_from"></b-form-input>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="exp_to Cost" :rules="{ required: true, regex: /^\d*\.?\d*$/ }"
                    ...
                    <b-form-group :label="$t('exp_to')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="ProductCost-feedback"
                        label="Cost" :placeholder="$t('exp_to')" v-model="center.exp_to"></b-form-input>
                      <b-form-invalid-feedback id="ProductCost-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="ar_address" :rules="{ required: true, min: 3, max: 600 }"
                    ...
                    <b-form-group :label="$t('ar_address')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="share" :placeholder="$t('ar_address')" v-model="center.ar_address"></b-form-input>
                      <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="en_address" :rules="{ required: true, min: 3, max: 600 }"
                    ...
                    <b-form-group :label="$t('en_address')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                        label="share" :placeholder="$t('en_address')" v-model="center.en_address"></b-form-input>
                      <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0]
                      }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                ...
                <b-col md="6" class="mb-6">
                  <validation-provider :name="dataArray">
                    <b-form-group slot-scope="{ valid, errors }" :label="$t('activites')">
                      <v-select :class="{ 'is-invalid': !!errors.length }"
                        :state="errors[0] ? false : (valid ? true : null)" v-model="center.actives"
                  ...
                  <b-col md="12 mb-5">
                    <div id="my-strictly-unique-vue-upload-multiple-image" class="d-flex justify-content-center">
                      <vue-upload-multiple-image @upload-success="uploadImageSuccess" @before-remove="beforeRemove"
                        dragText="Drag & Drop Multiple images For center" dropText="Drag & Drop image"
...
axios.get(
  ...
  .catch(response => {
    ...
    async onFileSelected(e) {
      ...
      if (valid) {
        this.center.logo = e.target.files[0];
      } else {
        this.center.logo = "";
      }
    },
    ...
    async onFileSelectedBanner(e) {
      ...
      if (valid) {
        this.center.banner = e.target.files[0];
      } else {
        this.center.banner = "";
      }
    },
    ...
    Submit_Center() {
      ...
      // this.sendData()
      this.$refs.Create_Center.validate().then(success => {
        if (!success) {
          this.makeToast(
            "danger",
    ...
    getSecions() {
      axios
        .get("drops/list/data?type=CENTERS")
        .then(response => {
    ...
    Create_Center() {
      ...
      // append objet center
      Object.entries(self.center).forEach(([key, value]) => {
      ...
      axios
        .post("Centers", self.data)
        .then(response => {
          console.log(this.selectedOptions)
          // Complete the animation of theprogress bar.
          NProgress.done();
          self.SubmitProcessing = false;
          this.$router.push({ name: "index_centers" });
          this.makeToast(
            "success",
