...
<template>
  <div class="main-content">
    <breadcumb :page="$t('CenterDetails')" :folder="$t('Centers')"/>
          ...
          <b-col md="8">
            <table class="table table-hover table-bordered table-md">
              <tbody>
                <tr>
                  <td> {{  $t('ar_name') }}</td>
                  <th> {{  center.ar_name  }}</th>
                </tr>
                <tr>
                  <td> {{  $t('en_name')  }}</td>
                  <th> {{  center.en_name   }}</th>
                </tr>

                <tr>
                  <td> {{  $t('en_info')  }}</td>
                  <th v-html="center.en_info">  </th>
                </tr>


                <tr>
                  <td> {{  $t('ar_info')  }}</td>
                  <th v-html="center.ar_info">  </th>
                </tr>

                <tr>
                  <td> {{  $t('facilities_ar')  }}</td>
                  <th  v-html="center.facilities_ar"> </th>
                </tr>


                <tr>
                  <td> {{  $t('facilities_en')  }}</td>
                  <th  v-html="center.facilities_en"> </th>
                </tr>
