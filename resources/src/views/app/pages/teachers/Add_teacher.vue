...
<template>
  <div class="main-content">
    <breadcumb :page="$t('AddTeacher')" :folder="$t('Teachers')"/>
    <div v-if="isLoading" class="loading_page spinner spinner-primary mr-3"></div>

    <validation-observer ref="Create_Teacher" v-if="!isLoading">
...
export default {
  ...
  methods: {
    ...
    Submit_Teacher() {
      this.$refs.Create_Teacher.validate().then(success => {
        if (!success) {
          this.makeToast(
            "danger",
