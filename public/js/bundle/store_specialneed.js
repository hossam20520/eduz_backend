          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                if (valid) {
                  _this5.specialneed.banner = e.target.files[0];
                } else {
                  _this5.specialneed.banner = "";
                }
