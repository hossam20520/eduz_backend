  ...
  methods: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                if (valid) {
                  _this3.specialneed.banner = e.target.files[0];
                } else {
                  _this3.specialneed.banner = "";
                }
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                if (valid) {
                  _this4.specialneed.logo = e.target.files[0];
                } else {
                  _this4.specialneed.logo = "";
                }
    ...
    GetElements: function GetElements() {
      ...
      axios.get("Specialneeds/".concat(id, "/edit")).then(function (response) {
        _this7.specialneed = response.data.specialneed;
        _this7.areas = response.data.areas;
        _this7.govs = response.data.govs;
        console.log(response.data.govs); // this.files_activetiy = response.data.specialneed.activites_fiels.split(",").map(item => item.trim());

        _this7.specialneed.actives = response.data.specialneed.actives; // this.files_activetiy = response.data.specialneed.activites_fiels.split(",").map(item => item.trim());
        ...
        _this7.specialneeds = response.data.specialneeds;
        _this7.images = response.data.specialneed.images;
        _this7.images_tow = response.data.specialneed.images_tow; // this.image_tow = response.data.specialneed.image_tow;
