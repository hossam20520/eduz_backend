  ...
  methods: {
    ...
    GetElements: function GetElements() {
      ...
      axios.get("Kindergartens/".concat(id, "/edit")).then(function (response) {
        _this4.kindergarten = response.data.kindergarten;
        _this4.areas = response.data.areas;
        _this4.files_activetiy = response.data.kindergarten.activites_fiels.split(",").map(function (item) {
          return item.trim();
        ...
        _this4.images = response.data.kindergarten.images;
